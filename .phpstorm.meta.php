    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'YasinTgh\LaravelPostman\Contracts\RouteAnalyzerInterface' => \YasinTgh\LaravelPostman\Services\RouteAnalyzer::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/praktikum/Herd/reservations/public/storage' => 'string',
            ...
            'nova.license_key' => 'string',
            'nova.name' => 'string',
            'nova.domain' => 'NULL',
            'nova.path' => 'string',
            'nova.guard' => 'NULL',
            'nova.passwords' => 'NULL',
            'nova.middleware' => 'array',
            'nova.api_middleware' => 'array',
            'nova.asset_middleware' => 'array',
            'nova.pagination' => 'string',
            'nova.storage_disk' => 'string',
            'nova.currency' => 'string',
            'nova.actions.resource' => 'string',
            'nova.impersonation.started' => 'string',
            'nova.impersonation.stopped' => 'string',
            'nova.brand.logo' => 'string',
            ...
            'fortify.limiters.passkeys' => 'NULL',
            ...
            'postman.name' => 'string',
            'postman.description' => 'string',
            'postman.base_url' => 'string',
            'postman.routes.prefix' => 'string',
            'postman.routes.include.patterns' => 'array',
            'postman.routes.include.middleware' => 'array',
            'postman.routes.include.controllers' => 'array',
            'postman.routes.exclude.patterns' => 'array',
            'postman.routes.exclude.middleware' => 'array',
            'postman.routes.exclude.controllers' => 'array',
            'postman.structure.folders.strategy' => 'string',
            'postman.structure.folders.max_depth' => 'integer',
            'postman.structure.folders.mapping' => 'array',
            'postman.structure.naming_format' => 'string',
            'postman.structure.requests.default_body_type' => 'string',
            'postman.structure.requests.default_values' => 'array',
            'postman.auth.enabled' => 'boolean',
            'postman.auth.type' => 'string',
            'postman.auth.location' => 'string',
            'postman.auth.default.token' => 'string',
            'postman.auth.default.username' => 'string',
            'postman.auth.default.password' => 'string',
            'postman.auth.default.key_name' => 'string',
            'postman.auth.default.key_value' => 'string',
            'postman.auth.protected_middleware' => 'array',
            'postman.headers.Accept' => 'string',
            'postman.headers.Content-Type' => 'string',
            'postman.output.driver' => 'string',
            'postman.output.path' => 'string',
            'postman.output.filename' => 'string',
...
'images.default','app.name','app.env','app.debug','app.url',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/praktikum/Herd/reservations/public/storage',
...
'mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','nova.license_key','nova.name',
'nova.domain','nova.path','nova.guard','nova.passwords','nova.middleware',
'nova.api_middleware','nova.asset_middleware','nova.pagination','nova.storage_disk','nova.currency',
'nova.actions.resource','nova.impersonation.started','nova.impersonation.stopped','nova.brand.logo','queue.default',
...
'session.partitioned','session.serialization','inertia.ssr.enabled','inertia.ssr.runtime','inertia.ssr.ensure_runtime_exists',
'inertia.ssr.url','inertia.ssr.hot_url','inertia.ssr.ensure_bundle_exists','inertia.ssr.throw_on_error','inertia.pages.ensure_pages_exist',
'inertia.pages.paths','inertia.pages.extensions','inertia.testing.ensure_pages_exist','inertia.expose_shared_prop_keys','inertia.history.encrypt',
'inertia.devtools.enabled','inertia.devtools.except','inertia.devtools.storage.path','inertia.devtools.storage.ttl','inertia.devtools.storage.prune_interval',
'inertia.devtools.storage.limit','inertia.devtools.middleware','inertia.devtools.gate','inertia.devtools.redact.keys','inertia.devtools.redact.headers',
...
'fortify.lowercase_usernames','fortify.limiters.login','fortify.limiters.passkeys','fortify.paths.login','fortify.paths.logout',
...
'fortify.passkeys.timeout','fortify.features','passkeys.relying_party_id','passkeys.allowed_origins','passkeys.user_handle_secret',
'passkeys.timeout','passkeys.guard','passkeys.middleware','passkeys.management_middleware','passkeys.throttle',
'passkeys.redirect','postman.name','postman.description','postman.base_url','postman.routes.prefix',
'postman.routes.include.patterns','postman.routes.include.middleware','postman.routes.include.controllers','postman.routes.exclude.patterns','postman.routes.exclude.middleware',
'postman.routes.exclude.controllers','postman.structure.folders.strategy','postman.structure.folders.max_depth','postman.structure.folders.mapping','postman.structure.naming_format',
'postman.structure.requests.default_body_type','postman.structure.requests.default_values','postman.auth.enabled','postman.auth.type','postman.auth.location',
'postman.auth.default.token','postman.auth.default.username','postman.auth.default.password','postman.auth.default.key_name','postman.auth.default.key_value',
'postman.auth.protected_middleware','postman.headers.Accept','postman.headers.Content-Type','postman.output.driver','postman.output.path',
'postman.output.filename','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'nova.asset.','nova.asset.','nova.api.',
'nova.api.start-nova-impersonation','nova.api.stop-nova-impersonation','nova.api.','nova.api.','nova.api.',
'nova.api.','nova.api.','nova.api.','nova.api.','nova.api.',
'nova.api.','nova.api.','nova.api.','nova.api.','nova.api.',
'nova.api.','nova.api.','nova.api.','nova.api.','nova.api.',
'nova.api.','nova.api.','nova.api.','nova.api.','nova.api.',
'nova.api.','nova.api.','nova.api.','nova.api.','nova.api.',
...
'nova.api.','nova.api.','nova.api.','nova.api.','nova.api.',
'nova.api.','nova.api.','nova.api.','nova.api.','nova.api.',
'nova.api.','nova.api.','nova.api.','sanctum.csrf-cookie','login',
'nova.pages.login','nova.login','nova.logout','nova.passkey.login-options','nova.passkey.login',
'nova.passkey.confirm-options','nova.passkey.confirm','nova.passkey.registration-options','nova.passkey.store','nova.passkey.destroy',
'nova.pages.password.email','nova.password.email','nova.pages.password.reset','nova.password.reset','nova.pages.user-security','nova.pages.password.verify','nova.password.confirmation','nova.password.confirm','nova.pages.403',
'nova.pages.404','nova.pages.home','nova.pages.dashboard','nova.pages.dashboard.custom','nova.pages.index',
'nova.pages.create','nova.pages.detail','nova.pages.edit','nova.pages.replicate','nova.pages.lens',
'nova.pages.attach','nova.pages.edit-attached','type.index','type.store',
'type.show','type.update','type.destroy','aircraft.index','aircraft.store',
'aircraft.show','aircraft.update','aircraft.destroy','reservation.index','reservation.store',
'reservation.show','reservation.update','reservation.destroy',
...
'laravel-exceptions::layout','laravel-exceptions::minimal','notifications::email','nova::layout','nova::partials.meta',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','nova.en.validation.attached','nova.en.validation.relatable',
'nova::.Users.praktikum.Herd.reservations.vendor.laravel.nova.resources.lang.en.validation.attached','nova::.Users.praktikum.Herd.reservations.vendor.laravel.nova.resources.lang.en.validation.relatable',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','BCRYPT_ROUNDS',
'NOVA_LICENSE_KEY','LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL',
