...
class Aircraft extends Resource
{
     ...
     *
     * @var class-string<\App\Models\Aircraft>
     */
    ...
    public function fields(NovaRequest $request): array
    {
        return [
            ...
            Badge::make('Status')
                ->withIcons()
                ->map([
                    AircraftStatus::GROUNDED->value => 'danger',
                    AircraftStatus::AVAILABLE->value => 'success',
                    AircraftStatus::MAINTENANCE->value => 'warning',
                ])
                ->filterable(),
            BelongsTo::make('Type')
                ->filterable(),
